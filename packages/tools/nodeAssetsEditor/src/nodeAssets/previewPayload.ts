 ...
 * (PNG, JPEG, WebP) map to an IMAGE payload with its mime type; everything else — including glb and
 * any unrecognized bytes — maps to a SCENE so the existing glb preview path is preserved.
