...
export type DemoInlineJsonSource = {
    ...
    readonly json: string | DemoJsonObject;
};
...
/** JSON values allowed in serialized catalog payloads. */
export type DemoJsonValue = string | number | boolean | null | readonly DemoJsonValue[] | DemoJsonObject;

/** A JSON object used by serialized resource definitions. */
export type DemoJsonObject = { readonly [key: string]: DemoJsonValue };

type DemoSerializedBlock = {
    readonly customType: string;
    readonly id: number;
    readonly name: string;
    readonly [key: string]: DemoJsonValue | undefined;
};
...
/** A JSON-safe serialized NodeAsset graph payload. */
export type DemoNodeAssetGraph = {
    readonly name: string;
    readonly blocks: readonly DemoSerializedBlock[];
    readonly connections: readonly DemoSerializedConnection[];
};
...
export type DemoSerializedNodeGeometry = DemoJsonObject;
 ...
 */
export const LegacyDemoCatalogRegistry: DemoCatalog = {
