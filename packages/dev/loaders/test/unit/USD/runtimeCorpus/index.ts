...
export { RuntimeCorpusManifest, BoxAsset, CylinderAsset, HospitalBedAsset, PlaneAsset, RobotArmAsset, RoomAsset, StairsAsset, type IRuntimeCorpusEntry } from "./manifest";
