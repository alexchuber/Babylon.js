...
export { RuntimeCorpusManifest, BoxAsset, ConeAsset, DeliveryBoxAsset, HospitalBedAsset, PlaneAsset, RobotArmAsset, RoomAsset, StairsAsset, type IRuntimeCorpusEntry } from "./manifest";
