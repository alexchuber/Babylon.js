...
export const RuntimeCorpusManifest: readonly IRuntimeCorpusEntry[] = [PlaneAsset, BoxAsset, CylinderAsset, HospitalBedAsset, RobotArmAsset, RoomAsset, StairsAsset] as const;
