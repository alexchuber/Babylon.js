        ...
        it("registers every built-in block", () => {
            expect(registeredClassNames).toEqual(
                expect.arrayContaining([
                    ...
                    NodeGeometryInputBlock.ClassName,
