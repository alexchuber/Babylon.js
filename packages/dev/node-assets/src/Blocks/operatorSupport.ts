 ...
 * shared by GLTF_DOCUMENT and Universal operator blocks, so each block only has to dynamic-`import`
 ...
 * @param block - The operator block, which must expose one document-backed `input` and `output`.
