...
export function DumpData(
    ...
    _GetDumpRendererAsync().then((renderer) => {
        ...
        Tools.EncodeScreenshotCanvasData(renderer.canvas, (result) => successCallback?.(result), mimeType, fileName, quality, toArrayBuffer);
